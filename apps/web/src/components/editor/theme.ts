 ...
 */
/**
 * The style spec, exported so the design contract can be asserted directly
 * instead of through a rendered editor.
 */
export const atlasMarkdownThemeSpec: Record<string, Record<string, string>> = {
  '&': {
...
export const atlasMarkdownTheme = EditorView.theme(atlasMarkdownThemeSpec, { dark: true });
