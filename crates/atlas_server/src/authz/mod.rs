...
pub use authorized::{
    ...
    ProjectsDelete, ProjectsRead, ProjectsUpdate, RequiredScope, TaskRes, TasksCreate, TasksDelete,
    TasksRead, TasksUpdate, ViewerMin, WorkspaceRes, authorize_board_destination,
