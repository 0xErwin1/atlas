...
use atlas_api::{
    dtos::{
        ...
        documents::{
            ActorDto, AttachmentDto, BacklinkDto, CommentAttachmentDto, ConflictProblemDto,
            CopyDocumentRequest, CreateDocumentRequest, DocumentDto, DocumentPresenceResponse,
