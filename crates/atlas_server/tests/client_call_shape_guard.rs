...
/// visits is either one of PR1's 222 call-bearing methods or one of these 3
/// named delegates, and the two audits agree on the full 225-method
/// population with no method uncounted by either.
#[test]
fn method_namespace_map_size_reconciles_with_pr1s_extracted_call_count() {
    const PR1_EXTRACTED_CALL_COUNT: usize = 222;
...
const ATLAS_SERVER_TEST_PINS: &[(&str, usize)] = &[
    ...
    ("api_custos_authorize.rs", 0),
    ("v2_visibility_parity.rs", 0),
    ("api_custos_discover.rs", 0),
    ("api_custos_grant_authority.rs", 0),
    ...
    ("registry_provider_catalog.rs", 0),
    ...
    ("span_fields.rs", 0),
    ("startup_gate.rs", 0),
    ("support/client_routes.rs", 0),
    ("support/mod.rs", 0),
    ("support/path.rs", 0),
    ("support/route_matrix.rs", 0),
    ("support/scan.rs", 0),
    ("support/source_walk.rs", 0),
