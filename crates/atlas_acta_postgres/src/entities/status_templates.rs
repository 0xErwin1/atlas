...
pub mod platform_status_template {
    use super::*;
...
pub fn platform_status_template_from(m: platform_status_template::Model) -> PlatformStatusTemplate {
    PlatformStatusTemplate {
        id: PlatformStatusTemplateId(m.id),
        name: m.name,
        color: m.color,
        position_key: m.position_key,
        created_at: m.created_at,
