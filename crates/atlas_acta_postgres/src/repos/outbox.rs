//! Transactional-outbox repository, moved from
//! `atlas_server::persistence::repos::outbox` (S4 PR7).
...
use crate::entities::events_outbox::event_outbox;
use crate::entities::webhook_subscription::webhook_subscriptions;
